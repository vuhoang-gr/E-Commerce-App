...
const BackHeader = props => {
  ...
  const rightComponent =
    options.rightComponent === undefined ? null : options.rightComponent ===
      'Search' ? (
      <HeaderSearchButton
  ...
  return (
    <View style={containerStyle}>
      {options.hideLeftComponent && !searching ? (
        <View />
      ) : (
        <TouchableOpacity activeOpacity={0.7} onPress={onLeftComponentPress}>
